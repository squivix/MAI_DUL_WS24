...
def show_samples_tt(
    samples: torch.tensor, fname: str = None, nrow: int = 10, title: str = "Samples"
):
    from torchvision.utils import make_grid
...
def save_text_to_plot(text_samples, filename, image_width=600, image_height=900):
    ...
    title_font = ImageFont.truetype("Pillow/Tests/fonts/DejaVuSans.ttf", title_font_size)
    text_font = ImageFont.truetype("Pillow/Tests/fonts/DejaVuSans.ttf", text_font_size)
